...
public class pasarela_de_pago extends AppCompatActivity {
    ...
    private void startPayment(){
       ...
       // SynapTheme theme = new SynapDarkTheme(); // Fondo de tarjeta oscuro
    ...
    private SynapTransaction buildTransaction(){
        ...
        country.setCode("ARG"); // Código de País (ISO 3166-2)

        // Referencie al objeto moneda
        SynapCurrency currency=new SynapCurrency();
        // Seteo del código de moneda
        currency.setCode("PES"); // Código de Moneda - Alphabetic code (ISO 4217)
        ...
        address.setCountry("ARG"); // Código de País del cliente (ISO 3166-2)
        ...
        customer.setEmail("oruealexis428@gmail.com");
        customer.setPhone("3743473404");
        ...
        cardStorage.setUserIdentifier("oruealexis428@gmail.com"); // Puede ser cualquier identificador definido por el comercio
